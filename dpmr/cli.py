...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Decode dPMR metadata from offline IQ files.")
    parser.add_argument("targets", nargs="*", default=["data/dpmr_1_48000.rawiq"])
